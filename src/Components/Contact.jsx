  ...
  <>
    <div className="contact-container" id="contact">
      ...
      <form action="https://formspree.io/f/mgeboelg" method="post" id="formaction">
        ...
        <input type="email" name="email" placeholder="Your Email Here" id="input" className="email" required />
        <textarea id="textpanel" cols="30" rows="9" maxLength="500" name="message" className="message" placeholder="Write Your Message Here" required />
